...
class ScanDelegate(DefaultDelegate):
    ...
    def handleNotification(self, cHandle, data):
        ...
        print("Received data:")
        print(f"Raw bytes: {list(data)}")  # Print as a list of integers
        print(f"Hex format: {data.hex()}")  # Print in hexadecimal format
        print(f"ASCII format: {data.decode('ascii', errors='replace')}")  # Print as ASCII (if applicable)
